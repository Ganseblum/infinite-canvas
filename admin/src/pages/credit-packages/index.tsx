...
import { createAdminPackage, listAdminPackages, updateAdminPackage, type AdminPackage } from "@admin/services/api/admin";
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            {packagesQuery.isError ? (
                <QueryError error={packagesQuery.error} message={t("admin.packages.loadFailed")} onRetry={() => void packagesQuery.refetch()} />
            ) : (
                <Table<AdminPackage>
                    rowKey="id"
                    size="middle"
