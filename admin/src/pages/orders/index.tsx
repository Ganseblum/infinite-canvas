...
import { listAdminOrders, type AdminOrder } from "@admin/services/api/admin";
...
export default function AdminOrdersPage() {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            {ordersQuery.isError ? (
                <QueryError error={ordersQuery.error} message={t("admin.orders.loadFailed")} onRetry={() => void ordersQuery.refetch()} />
            ) : (
                <Table<AdminOrder>
                    rowKey="id"
                    size="middle"
