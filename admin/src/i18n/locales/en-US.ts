    ...
    "translation",
    {
        admin: {
            ...
            office: {
                ...
                description: "Review office assistant sessions and messages, with run health and usage breakdown.",
                sessionsTab: "Sessions",
                statsTab: "Analytics",
                filter: { user: "User email or ID", status: "Filter by status" },
                // Session status: always "active" in M1; add copy here when new values ship.
                statuses: { active: "Active" },
                runStatuses: { queued: "Queued", running: "Running", succeeded: "Succeeded", failed: "Failed", cancelled: "Cancelled" },
                columns: { user: "User", title: "Title", messages: "Messages", status: "Status", lastRunStatus: "Last run", updatedAt: "Updated" },
                detailTitle: "Session details",
                detail: { createdAt: "Created" },
                roleLabels: { user: "User", assistant: "Assistant" },
                messagesEmpty: "No messages in this session yet",
                loadFailed: "Failed to load sessions",
                detailLoadFailed: "Failed to load the session",
                stats: {
                    loadFailed: "Failed to load analytics",
                    range: { d7: "Last 7 days", d30: "Last 30 days" },
                    kpi: { runs: "Total runs", messages: "Messages", sessions: "Sessions", activeUsers: "Active users", successRate: "Run success rate" },
                    byStatus: { title: "Runs by status" },
                    byModel: { title: "Top 10 models", runs: "Runs" },
                    toolCalls: { title: "Top 10 tool calls", calls: "Calls" },
                    topUsers: { title: "Top 10 active users", user: "User", runs: "Runs", messages: "Messages" },
                },
            },
            membership: {
