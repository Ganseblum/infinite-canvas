export default {
    ...
    settingsPanels: {
        ...
        model: { select: "选择模型", empty: "管理员尚未上架模型", points: "约 {{points}} 点", capabilities: { image: "生图", video: "视频", text: "文本", audio: "音频" } },
    },
    ...
    profile: {
        ...
        retry: "重试",
        nav: { basic: "资料", credits: "点数与流水", usage: "存储与用量", security: "安全设置", danger: "危险区" },
        ...
        danger: {
            title: "危险区",
            description: "注销账号会立即停止生成与充值，冷静期结束后数据将被清理。",
            deleteAccount: "注销账号",
            pendingTitle: "账号注销申请已提交",
            pendingDescription: "账号将于 {{date}} 到期注销，到期后数据将被清理且不可恢复。",
            ...
            bulletData: "冷静期结束后，账号资料、云端项目与媒体文件会被清理，不可恢复。",
            password: "输入密码确认",
            passwordRequired: "请输入密码",
            submit: "提交注销申请",
    ...
    billing: {
        ...
        providers: { alipay: "支付宝", wechat: "微信支付" },
        points: "{{points}} 点数",
        bonus: "赠送 {{points}} 点数",
