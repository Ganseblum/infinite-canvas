export default {
    ...
    modelPlugin: {
        ...
        authoring: {
            intro: "请为优刻编写一段模型调用脚本。能力类型：{{capability}}。目标模型：{{model}}。",
    ...
    pricing: {
        ...
        rows: { storage: "存储配额", maxFile: "单文件上限", retention: "媒体保留期", imageTrials: "图片免费试用", videoTrials: "视频免费试用" },
        retentionValue: "{{count}} 天",
        trialsValue: "{{count}} 次",
        trialsNone: "无",
        ctaTitle: "需要更多点数？",
