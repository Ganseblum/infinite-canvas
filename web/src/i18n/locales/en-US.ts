export default {
    ...
    pricing: {
        ...
        rows: { storage: "Storage quota", maxFile: "Max file size", retention: "Media retention", imageTrials: "Free image trials", videoTrials: "Free video trials" },
        retentionValue: "{{count}} days",
        trialsValue: "{{count}}",
        trialsNone: "None",
