...
export default {
    ...
    workbench: {
        ...
        ratingDialogTitle: "What went wrong with this result?",
        ratingDialogHint: "Select the issues you ran into (multiple choice) and add details if you like",
        ratingNotePlaceholder: "Details (optional)",
        ratingSubmit: "Submit feedback",
        ratingLabels: ["Poor quality", "Ignored the prompt", "Distorted", "Broken details", "Wrong style", "Incomplete"],
    ...
    imageWorkbench: {
        ...
        remixLoaded: "Loaded \"{{title}}\" as a reference",
    ...
    oauth: {
        authorizePending: "Authorizing and redirecting…",
        authorizeFailed: "Authorization redirect failed",
        authorizeRetry: "Retry",
    },
    feedback: {
        title: "Feedback",
        description: "Ran into an issue or have a suggestion? Submit feedback and support will reply in the ticket.",
        create: "New feedback",
        submit: "Submit",
        contentPlaceholder: "Describe the issue or suggestion (2-1000 characters)",
        ...
        staffLabel: "Support",
        selfLabel: "Me",
        noReplies: "Support will reply here soon.",
