export default {
    ...
    settingsPanels: {
        ...
        model: { select: "Select model", empty: "No models are available yet", points: "~{{points}} credits", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" } },
    },
    ...
    profile: {
        ...
        retry: "Retry",
        nav: { basic: "Profile", credits: "Credits", usage: "Storage", security: "Security", danger: "Danger zone" },
        ...
        danger: {
            title: "Danger zone",
            description: "Deleting your account stops generation and top-ups immediately; data is removed after the cooling-off period.",
            deleteAccount: "Delete account",
            pendingTitle: "Account deletion scheduled",
            pendingDescription: "The account will be deleted on {{date}}; data cannot be recovered afterward.",
            ...
            bulletData: "After the cooling-off period, your profile, cloud projects, and media files are removed permanently.",
    ...
    billing: {
        ...
        providers: { alipay: "Alipay", wechat: "WeChat Pay" },
